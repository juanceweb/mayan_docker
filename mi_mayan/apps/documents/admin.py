...
from .models.document_models import Document, Constancia_Examen, Solicitud_Aviso_Ultimo_Examen
...
@admin.register(Constancia_Examen)
class Constancia_Examen_Admin(admin.ModelAdmin):
    pass

@admin.register(Solicitud_Aviso_Ultimo_Examen)
class Solicitud_Aviso_Ultimo_Examen_Admin(admin.ModelAdmin):
    pass
