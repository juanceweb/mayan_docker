...
from .document_models_unq import (Constancia_Examen, Solicitud_Aviso_Ultimo_Examen, 
...
class Document(
    ...
    * uuid - UUID of a document, universally Unique ID. An unique identifier
    ...
    constancia_examen = models.OneToOneField(Constancia_Examen,
        ...
        help_text=_('si el doc es una constancia de examen.'),
        on_delete=models.CASCADE, related_name='extras',
        verbose_name=_('constancia examen'))
    
    solicitud_aviso_ultimo_examen = models.OneToOneField(Solicitud_Aviso_Ultimo_Examen,
        null=True, blank=True,
        help_text=_('si el doc es una solicitud de aviso de ultimo examen.'),
        on_delete=models.CASCADE, related_name='extras',
        verbose_name=_('solicitud aviso ultimo examen'))
    
    constancia_aprobacion_materia = models.OneToOneField(Constancia_Aprobacion_Materia,
        null=True, blank=True,
        help_text=_('si el doc es una constancia de aprobacion de materia.'),
        on_delete=models.CASCADE, related_name='extras',
        verbose_name=_('constancia aprobacion materia'))
    
    solicitud_baja_propuesta_guarani = models.OneToOneField(Solicitud_Baja_Propuesta_Guarani,
        null=True, blank=True,
        help_text=_('si el doc es una solicitud de baja de propuesta guarani.'),
        on_delete=models.CASCADE, related_name='extras',
        verbose_name=_('solicitud baja propuesta guarani'))
    
    solicitud_certificado_aprobacion = models.OneToOneField(Solicitud_Certificado_Aprobacion,
        null=True, blank=True,
        help_text=_('si el doc es una solicitud de certificado aprobacion.'),
        on_delete=models.CASCADE, related_name='extras',
        verbose_name=_('solicitud certificado aprobacion'))
    
    solicitud_equivalencias_guarani = models.OneToOneField(Solicitud_Equivalencias_Guarani,
        null=True, blank=True,
