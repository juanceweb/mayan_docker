# Generated by Django 3.2.16 on 2023-02-17 17:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('documents', '0095_auto_20230217_1440'),
    ]

    operations = [
        migrations.CreateModel(
            name='Solicitud_Equivalencias_Guarani',
            fields=[
        ...
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Solicitud Certificado Aprobacion', 'verbose_name_plural': 'Solicitud Certificado Aprobacion'},
        ),
        migrations.AddField(
            model_name='document',
            name='solicitud_equivalencias_guarani',
            field=models.OneToOneField(blank=True, help_text='si el doc es una solicitud de equivalencias guarani.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='extras', to='documents.solicitud_equivalencias_guarani', verbose_name='solicitud equivalencias guarani'),
        ),
    ]
