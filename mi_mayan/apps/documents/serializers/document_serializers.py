...
from .document_serializers_unq import (Constancia_Examen_Serializer, Solicitud_Aviso_Ultimo_Examen_Serializer, 
...
class DocumentSerializer(serializers.HyperlinkedModelSerializer):
    ...
    constancia_aprobacion_materia = Constancia_Aprobacion_Materia_Serializer(read_only=True)

    solicitud_baja_propuesta_guarani = Solicitud_Baja_Propuesta_Guarani_Serializer(read_only=True)

    solicitud_certificado_aprobacion = Solicitud_Certificado_Aprobacion_Serializer(read_only=True)
